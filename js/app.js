    ...
    (() => {
        ...
        function menuInit() {
            ...
            window.addEventListener("click", (e => {
                ...
                if (!target.closest(".menu__icon") && !target.closest("menu__body")) document.documentElement.classList.remove("menu-open");
            }));
        }
        function menuClose() {
            bodyUnlock();
        ...
        scrollBlock();
        const seats = document.querySelectorAll(".selection-time-table__item");
        if (seats) {
