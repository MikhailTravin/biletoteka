 ...
 */
    ...
    (() => {
        ...
        document.querySelectorAll(".block").forEach((n => {
            new core(n.querySelector(".block__slider"), {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
        ...
        if (searchButton) {
            const searchContent = document.querySelector(".search-top-header__content");
            const searchClose = document.querySelector(".search-close");
            searchButton.addEventListener("click", (function(e) {
                searchContent.classList.add("_search-open");
            }));
            searchClose.addEventListener("click", (function(e) {
                searchContent.classList.remove("_search-open");
            }));
            window.addEventListener("click", (e => {
                const target = e.target;
                if (!target.closest(".search-top-header__simplebar") && !target.closest(".form__icon") && !target.closest(".form__input input")) searchContent.classList.remove("_search-open");
            }));
        }
        const calendar = document.querySelector(".calendar__main");
        if (calendar) {
            const input = document.querySelector("#date");
            document.querySelector(".calendar__header");
        ...
        if (blogItems.length > 0) {
            let blogFilters = document.querySelectorAll(".navigation-filter-poster__title");
            if (blogFilters.length > 0) {
                for (let index = 0; index < blogFilters.length; index++) {
                    ...
                    blogFilter.addEventListener("click", (function(e) {
                        ...
                        const blogFilterActive = document.querySelector(".navigation-filter-poster__title._active");
        ...
        function script_scroll() {
            let scroll = document.querySelector(".filter-poster__navigation");
            if (scroll) {
                let speed = 2;
                let left = 0;
                let top = 0;
